...
constructor(camera,dom){this.camera=camera;this.dom=dom;this.keys={};this.yaw=0;this.pitch=0;this.sensitivity=.0065;this.touchSensitivity=.042;this.touchPitchSensitivity=.042;this.locked=false;
