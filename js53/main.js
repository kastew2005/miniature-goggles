...
class Game{
 ...
 async start(){
  ...
  try{
    ...
    try{ this.world.processMeshQueue(220); }
    ...
    setTimeout(()=>{
      try{
        if(this.running && this.world.chunks.size>0 && this.world.meshes.size===0){
          ...
          this.world.processMeshQueue(220);
