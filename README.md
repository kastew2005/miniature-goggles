...
- Consolidated touch controls with no legacy oversized CSS overrides.
- Separate joystick and camera pointer streams for multitouch.
- Faster touch camera sensitivity.
- New touch-layout storage key so stale Universe 68 layouts are not reused.
- Landscape-first responsive layout for phones and tablets.
